...
def _scale_leach_train_blocks(model, csb):
    ...
    csb.set_variable_scaling_factor(model.fs.leach.volume[0, 1], 1 / 378.5)
...
m.fs.leach.solid_inlet.flow_mass.fix(22.67 * units.kg / units.hour)
...
_scale_leach_train_blocks(m, csb2)
...
to_json(m, fname="FOCAPO_leaching.json", human_read=True)
